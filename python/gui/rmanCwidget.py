...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.gridLayout_2.addWidget(self.min_v_value, 1, 1, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.max_v_value, 1, 2, 1, 1)
    ...
    def retranslateUi(self, Form):
        ...
        self.label_4.setText(_translate("Form", "Min/Max Value:", None))
